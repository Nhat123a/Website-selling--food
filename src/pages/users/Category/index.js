        ...
        <div className="grid grid-cols-4   mb-8 gap-3 justify-between items-start">
          ...
          >
            {activeSort && (
              <div
                ref={slideBaref}
                className={`Category__left ${animationClass} 
               bg-white px-4 pt-[10px] w-[256px] overflow-y-auto overflow-hidden fixed top-0 
           bottom-0 right-0 z-20 lg:relative lg:p-0 lg:bg-transparent`}
              >
                {/* Danh mục */}
