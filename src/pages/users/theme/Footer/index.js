...
const data = [
  {
    ...
    Name: "Chính sách",
    item_link: [
      { name: "Chính sách thành viên", slug: "/" },
      { name: "Chính sách thanh toán", slug: "/" },
      { name: "Chính sách đổi sản phẩm", slug: "/" },
      { name: "Chính sách bảo mật", slug: "/" },
      { name: "Chính sách cộng tác viên", slug: "/" },
      { name: "Chính sách bảo hành", slug: "/" },
    ],
  },
  {
    ID: 2,
    Name: "HƯỚNG DẪN",
    item_link: [
      { name: "Hướng dẫn mua hàng", slug: "/" },
      { name: "Hướng dẫn đổi trả", slug: "/" },
      { name: "Hướng dẫn thanh toán", slug: "/" },
      {
        name: "Chương trình cộng tác viên",
        slug: "/",
      },
      { name: "Tìm kiếm", slug: "/" },
      { name: "Liên hệ", slug: "/Lien-he-voi-chung-toi" },
    ],
  },
];
const media__url = [
